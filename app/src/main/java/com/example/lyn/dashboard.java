...
public class dashboard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        i2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(dashboard.this, Mentors.class);
                startActivity(i);
        ...
        i3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(dashboard.this, Online.class);
                startActivity(i);
        ...
        i4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(dashboard.this, Offline.class);
                startActivity(i);
        ...
        i7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(dashboard.this, youtube.class);
                startActivity(i);
        ...
        i8.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(dashboard.this, material.class);
                startActivity(i);
                                ...
                                public void onClick(View v) {
                                    ...
                                    if (eventType.equals("C")) {
                                        ...
                                        if (!meetingurl.isEmpty()) {
                                            ...
                                            Toast.makeText(dashboard.this, "URL is not available for the event: " + eventName, Toast.LENGTH_SHORT).show();
                                        }
                                    } else if (eventType.equals("D")) {
                                        if (!meetingurl.isEmpty()) {
                                            // Open QPLink in next activity
                                            Intent intent = new Intent(dashboard.this, OfflineWebview.class);
                                            intent.putExtra("url", meetingurl);
                                            ...
                                            Toast.makeText(dashboard.this, "QPLink is empty for this event", Toast.LENGTH_SHORT).show();
                                        }
                                    } else if (eventType.equals("E") || eventType.equals("M")) {
                                        if (!meetingurl.isEmpty()) {
                                            // Open QPLink in WebView
                                            // Inside the FetchDataAsyncTask onPostExecute method
                                            Intent intent = new Intent(dashboard.this, OnlineWebview.class);
                                            intent.putExtra("url", meetingurl);
                                            Log.d("Online", "URL: " + meetingurl);
                                            startActivity(intent);
                                        ...
                                        Toast.makeText(dashboard.this, "QPLink is not available for this event type", Toast.LENGTH_SHORT).show();
    ...
    protected void onResume() {
        ...
        if (isMeetingClicked) {
            ...
            if (startTimeString != null && !startTimeString.isEmpty() && endTimeString != null && !endTimeString.isEmpty() && id != null) {
                ...
                Toast.makeText(dashboard.this, "Failed to log attendance: Start or end time is invalid", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private class InsertAttendanceAsyncTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(Boolean success) {
            ...
            if (success) {
                Toast.makeText(dashboard.this, "Attendance logged successfully", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(dashboard.this, "Failed to log attendance", Toast.LENGTH_SHORT).show();
            }
        }
    }
