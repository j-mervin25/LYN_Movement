...
public class materialweb extends AppCompatActivity {
    WebView mWebView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_materialweb);
        String url = getIntent().getStringExtra("fileLocation");
        Log.d("materialwebview", "URL: " + url);
        ...
        mWebView.loadUrl("https://trial.gssmp.org/" +url);
